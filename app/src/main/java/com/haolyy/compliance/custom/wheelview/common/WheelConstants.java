 ...
 */
package com.haolyy.compliance.custom.wheelview.common;
...
public class WheelConstants {
     ...
     * holo皮肤默认选中框颜色
     */
    public static final int WHEEL_SKIN_HOLO_BORDER_COLOR = Color.parseColor("#00000000");
     ...
     * 滚轮停止时展示选中项
     */
    public static final int WHEEL_SCROLL_HANDLER_STOP = 0x0101;
