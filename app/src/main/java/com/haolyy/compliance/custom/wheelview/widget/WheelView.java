 ...
 */
package com.haolyy.compliance.custom.wheelview.widget;
...
import com.haolyy.compliance.custom.wheelview.adapter.SimpleWheelAdapter;
import com.haolyy.compliance.custom.wheelview.common.WheelConstants;
import com.haolyy.compliance.custom.wheelview.common.WheelViewException;
import com.haolyy.compliance.custom.wheelview.graphics.DrawableFactory;
import com.haolyy.compliance.custom.wheelview.util.WheelUtils;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    private OnWheelItemStopListener<T> mOnWheelItemStopListener;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            } else if (msg.what == WheelConstants.WHEEL_SCROLL_HANDLER_STOP) {
                if (mOnWheelItemStopListener != null) {
                    mOnWheelItemStopListener.onItemStopSelected(getCurrentPosition(), getSelectionItem());
                }
                if (mJoinWheelView != null) {
                    if (!mJoinMap.isEmpty()) {
     ...
     * 设置滚轮停止时事件，监听滚轮选中项
     *
     * @param onWheelItemStopListener
     */
    public void setOnWheelItemStopListener(OnWheelItemStopListener<T>
                                                   onWheelItemStopListener) {
        mOnWheelItemStopListener = onWheelItemStopListener;
    }
    ...
    private void refreshCurrentPosition(boolean join) {
        ...
        mHandler.removeMessages(WheelConstants.WHEEL_SCROLL_HANDLER_STOP);
        mHandler.sendEmptyMessageDelayed(WheelConstants.WHEEL_SCROLL_HANDLER_STOP, WheelConstants.WHEEL_SCROLL_DELAY_DURATION);
    }
    ...
    public interface OnWheelItemStopListener<T> {
        void onItemStopSelected(int position, T t);
    }
