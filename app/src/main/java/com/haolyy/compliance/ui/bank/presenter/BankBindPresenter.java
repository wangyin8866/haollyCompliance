...
public class BankBindPresenter extends BasePresenter<BankBindView> {
    ...
    public void sendSms(String busi_type_, String card_number_, String user_cust_id, final String mer_id_, String mobile_, String sms_type_, final int useType,String client_) {
    ...
    public void register(String mer_id_, String moblie_, String from_mobile_, String id_number_, String user_name_, String card_number_, final String bank_id_, String sms_code_, String sms_seq_, String PageType, String ret_url_, String user_type_, String version_, String user_id, String client) {
        ...
        invoke(HuifuShModel2.getInstance().register(mer_id_, moblie_, from_mobile_, id_number_, user_name_, card_number_, bank_id_, sms_code_, sms_seq_, PageType, ret_url_, user_type_, version_, user_id, client), new ProgressSubscriber<String>(new SubscriberOnNextListener<String>() {
            @Override
