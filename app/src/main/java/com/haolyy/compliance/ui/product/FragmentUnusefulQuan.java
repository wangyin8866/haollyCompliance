...
import com.haolyy.compliance.adapter.UnUseQuansAdapter;
...
public class FragmentUnusefulQuan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_unuseful_quan, container, false);
...
//        }
        ...
        lvUnuseful.setAdapter(new UnUseQuansAdapter(repayments,getContext()));
    }
