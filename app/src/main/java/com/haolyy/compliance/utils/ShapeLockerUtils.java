...
public class ShapeLockerUtils {

    //private static final String TAG = "LockPatternUtils";
    private final static String KEY_LOCK_PWD = "com.haolyy.compliance.shapelocker.lock_pwd";
    ...
    public ShapeLockerUtils(Context context) {
        mContext = context;
